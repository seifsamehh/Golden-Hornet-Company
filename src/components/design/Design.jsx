...
import DesignServices from "../products/DesignServices";

const Design = () => {
  return (
    <section className="design flex justify-center items-start min-[290px]:flex-wrap md:flex-nowrap gap-12 pb-6 min-[290px]:mx-4 md:mx-12">
      <div className="left bg-[#0f75bd] text-white md:w-[250px] px-2 py-6 rounded-xl border-2 border-[#1e1e1e] dark:border-[#ffcc00] border-solid md:min-h-screen flex min-[290px]:flex-row md:flex-col min-[290px]:flex-wrap md:flex-nowrap justify-start gap-6 min-[290px]:hidden md:block">
      ...
      <div className="w-full right">
        <h2 className="mb-2 text-3xl font-bold dark:text-[#ffcc00]">Design</h2>
        <p className="leading-8 mb-4 dark:text-white">
          Design is a world of art that needs a special imprint that expresses
          your ideas, and this is what you can get by hiring creative designers.
        </p>
        <DesignServices />
      </div>
    </section>
