...
const services = [
  {
    name: "4 Pages Website",
    price: 61000,
    description: "Develop 4 Pages for your website.",
  },
  {
    name: "Landing Page",
    price: 20500,
    description: "Develop a full responsive landing page.",
  },
  {
    name: "SEO Package",
    price: 76000,
    description: "Make Your SEO for 3 months.",
  },
  {
    name: "E-commerce Website",
    price: 60000,
    description: "Develop a full-fledged e-commerce website.",
  },
  {
    name: "Cross Platform",
    price: 210000,
    description: "Develop a cross platform ( website , mobile app ).",
  },
];
...
const Service = () => {
  ...
  return (
    <div className="services-box bg-white dark:bg-[#0F75BD] border-2 border-solid border-[#1e1e1e] rounded-lg p-4">
      <ul className="box flex justify-start items-start flex-wrap gap-6">
          ...
          >
            <div className="content">
              ...
              <p className="text-[#0f75bd] text-xl font-bold">
                {service.price.toLocaleString("en-EG", {
                  style: "currency",
                  currency: "EGP",
              ...
              <button
                ...
                className="bg-[#ffcc00] text-[#1e1e1e] font-bold rounded-md p-2 mt-6 w-fit"
              >
                <svg
                  width={30}
                  height={30}
